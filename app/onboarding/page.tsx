...
export default function OnboardingPage() {
  ...
  const canContinue =
    step === 1 ? Boolean(sheet) : step === 2 ? Boolean(placementDate) : true;
              ...
              {SHEET_OPTIONS.map((option) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span className="text-card-title pr-6">{option.label}</span>
          ...
          {step === 2 ? (
            <div className="mt-8 space-y-10">
              ...
              <div>
                ...
                >
                  I can practice{" "}
                  <span className="font-mono text-foreground">{dailyHours}</span>{" "}
                  hours/day
                </label>
                <input
                  id="daily-hours"
          ...
          {step === 3 ? (
            <div className="mt-8 space-y-8">
              <p className="text-center text-sm text-muted-foreground">
                Select up to {MAX_COMPANIES} companies to track your readiness.
              </p>
